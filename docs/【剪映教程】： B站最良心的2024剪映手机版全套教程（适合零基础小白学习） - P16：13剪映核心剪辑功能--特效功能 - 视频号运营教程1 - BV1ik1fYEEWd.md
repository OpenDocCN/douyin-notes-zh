# 【剪映教程】： B站最良心的2024剪映手机版全套教程（适合零基础小白学习） - P16：13剪映核心剪辑功能--特效功能 - 视频号运营教程1 - BV1ik1fYEEWd
...
在剪映的特效功能当中啊，它加入了大量的一个特效素材库。那我们通过在视频当中植入相应的特效视频元素。可以。大幅度提升我们视频营的整体的一个画面感觉和氛围，尤其是在做。一些变装类呀。
...
在这个视频当中就拥有了大量的一个特效的元素。好，那关于特效介绍这块，我们就先到这块。然后呢，接下来是跟大家一块进行一个实操的演练。好，我们进入剪易软件当中。好，我们同样首先呢是。先看一下这个成品。
...
那开场这一块它是借用到了一个什么模糊变清晰这样一个特效元素。那紧接着第二个的话是他在这个跳舞的时候，背景运用了这个什么。啊，也是一个紫色这样一个特效元素。那包括最后啊出现这个抖动的模糊智障。
...
然后我们选择这会儿看到了没有？有一个基础类的特效变清晰。我们点击。好，那么就相当于给视频添加上这样一个模糊变清晰的一个特效，是第一个。然后我们接着再看，第二个就是我们看到的在跳舞的时候。
...
对。返回到我们的上一层菜单，然后新增特效，再给他添加一个啊，添加一个什么。梦幻类别啊有一个叫邀请，就是他跳舞那一段。好，我们再添下第二个特效。那第三个特效呢，我们同样啊把这个时间轴拉长。

第三个是代啥甩头发这一块还有一个特效。我们再新增一个特效。那甩头发这块是用了一个什么？动感的啊横纹制造，我选择这个。局长。好，我们调整一下。调动下时长。来看一下基本的效果。啊。
